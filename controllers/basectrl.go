...
func (this *Controller) Prepare() {
	...
	switch path {
	case "/api/users/current", "/api/users/forgot_password", "/api/users/forgot_password/phone", "/api/users/forgot_password/reset", "/api/machine_types", "/api/machines/search", "/api/locations", "/api/locations/my_ip", "/api/metrics/realtime", "/api/reservations/icalendar", "/api/settings/terms_url", "/api/newsletters/easylab_dev":
	default:
