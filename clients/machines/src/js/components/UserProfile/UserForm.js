...
var UserForm = React.createClass({
   ...
   */
  render() {
    // Prepare data for country code select element
    ...
    var countryCodes = JSON.parse(countryCodesJSON);
    var CountryCodeSelectOptions = _.map(countryCodes, function(value, key) {
      return (
