...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsApp = __webpack_require__(1);

	var _componentsApp2 = _interopRequireDefault(_componentsApp);

	var _componentsLogin = __webpack_require__(197);

	var _componentsLogin2 = _interopRequireDefault(_componentsLogin);

	var _componentsUserPage = __webpack_require__(201);

	var _componentsUserPage2 = _interopRequireDefault(_componentsUserPage);
	...
	var routes = _react2['default'].createElement(
	    ...
	    _react2['default'].createElement(_reactRouter.Route, { name: 'user', handler: _componentsUserPage2['default'] }),
	    _react2['default'].createElement(_reactRouter.Route, { name: 'login', handler: _componentsLogin2['default'] }),
	    _react2['default'].createElement(_reactRouter.DefaultRoute, { handler: _componentsUserPage2['default'] }),
	    _react2['default'].createElement(_reactRouter.NotFoundRoute, { handler: _componentsUserPage2['default'] })
	);

	_reactRouter2['default'].run(routes, _reactRouter2['default'].HistoryLocalion, function (Handler) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storesUserStore = __webpack_require__(198);

	var _storesUserStore2 = _interopRequireDefault(_storesUserStore);

	var _actionsLoginActions = __webpack_require__(200);
	...
	var Login = _react2['default'].createClass({
	    ...
	    handleSubmit: function handleSubmit(event) {
	        event.preventDefault();
	        _actionsLoginActions2['default'].submitLoginForm(this.state);
	        this.clearAndFocus();
	        if (_storesUserStore2['default'].getIsLogged) {
	            this.transitionTo('/');
	        }
	    },
	    ...
	    clearAndFocus: function clearAndFocus() {
	        this.setState({ username: '', password: '' }, function () {
	            _react2['default'].findDOMNode(this.refs.name).focus();
	        });
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserStore = {
	     ...
	     *
	     */
	    getDataFromServer: function getDataFromServer(_url, stateName, _dataToSend, _type, functionIfFail) {
	        $.ajax({
	            url: _url,
	            dataType: "json",
	            type: _type,
	    ...
	    // It seems to work
	    submitLoginFormToServer: function submitLoginFormToServer(loginInfo) {
	    ...
	    // Logout from server
	    logoutFromServer: function logoutFromServer() {
	        $.ajax({
	    ...
	    submitStateToServer: function submitStateToServer(userState) {
	    ...
	    getUserStateFromServer: function getUserStateFromServer() {},

	    // Change the input to match the rawInfoUser format
	    formatUserStateToSendToServer: function formatUserStateToSendToServer(userState) {
	    ...
	    formatUserStateToSendToUserPage: function formatUserStateToSendToUserPage() {
	        var infoWhichMatter = ["FirstName", "LastName", "Username", "Email", "InvoiceAddr", "ShipAddr"];
	        var lightState = {};
	    ...
	    // Use by UserPage to get its state
	    getInfoMachine: function getInfoMachine() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginActions = {
	    submitLoginForm: function submitLoginForm(content) {
	        _storesUserStore2['default'].submitLoginFormToServer(content);
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserForm = __webpack_require__(203);

	var _UserForm2 = _interopRequireDefault(_UserForm);

	var _MachineList = __webpack_require__(204);

	var _MachineList2 = _interopRequireDefault(_MachineList);

	var _Membership = __webpack_require__(202);

	var _Membership2 = _interopRequireDefault(_Membership);

	var _actionsUserActions = __webpack_require__(205);
	...
	var UserPage = _react2['default'].createClass({
	    ...
	    getInitialState: function getInitialState() {
	        var _infoUser = _storesUserStore2['default'].getInfoUser();
	        console.log(_infoUser);
	        var _infoMachine = _storesUserStore2['default'].getInfoMachine();
	    ...
	    handleSubmit: function handleSubmit() {
	        ...
	        _actionsUserActions2['default'].submitState(this.state.infoUser);
	    },
	     ...
	     */
	    // Change the state of the input related
	    handleChangeForm: function handleChangeForm(event) {
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_UserForm2['default'], { info: this.state.infoUser,
	                func: this.handleChangeForm,
	                submit: this.handleSubmit
	            }),
	            _react2['default'].createElement(_MachineList2['default'], { info: this.state.infoMachine }),
	            _react2['default'].createElement(_Membership2['default'], null)
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Membership = _react2["default"].createClass({
	...
	var UserForm = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        var NodeInput = infoUserTmp.map(function (info) {
	            return _react2['default'].createElement('input', { type: 'text', value: info.value,
	                id: info.key,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MachineList = _react2["default"].createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserActions = {
	    ...
	    submitState: function submitState(userState) {
	        _storesUserStore2['default'].submitStateToServer(userState);
	    },

	    logout: function logout() {
	        _storesUserStore2['default'].logoutFromServer();
	    }
